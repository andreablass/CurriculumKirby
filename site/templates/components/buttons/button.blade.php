<a {{ $attributes->class(['bg-gray-800', 'text-white', 'font-semibold', 'py-2', 'px-4', 'rounded-lg', 'transition', 'duration-300', 'ease-in-out', 'hover:bg-pink-700', 'focus:outline-none', 'focus:ring-2', 'active:bg-gray-800', 'active:text-white', 'rounded-full']) }}>
    {{--
